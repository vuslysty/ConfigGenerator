...
public sealed class DatabaseTableCandidateParser : ITableCandidateParser
{
    public bool TryParse(TableParsingContext context, out TableData? tableData)
    {
        ...
        tableData = DatabaseTableExtractor.Parse(context.StartRow, context.StartCol, context.TableName, context.PageData);
        return true;
    }
}
