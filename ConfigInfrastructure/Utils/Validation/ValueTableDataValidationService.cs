...
{
    private const string ValidationStep = OperationSteps.Validation.ValueData;

    public static void Validate(ValueTableData valueTableData, AvailableTypes availableTypes, OperationResult result)
    {
