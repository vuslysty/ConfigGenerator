...
{
    private const string ValidationStep = OperationSteps.Validation.DatabaseData;

    public static void Validate(DatabaseTableData databaseTableData, AvailableTypes availableTypes, OperationResult result)
    {
